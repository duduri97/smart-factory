...
export default function TotalYieldChart() {
  return (
    <>
      <div style={style.chartDescription1}>Total Yield</div>
      ...
      <div
        ...
        <div style={{ alignItems: 'center' }}>
          {/* <TotalYieldChart /> */}
          <ReactApexChart options={options} series={[88.3]} type="radialBar" height={'100%'} />
        </div>
